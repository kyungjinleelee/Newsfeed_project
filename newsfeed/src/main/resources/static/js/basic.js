    ...
    $.ajax({
      ...
      //  url: `/`,
        ...
        .done(function (res, status, xhr) {
            ...
            $('#username').text(username);  // html에 사용자 정보 표시
            if (isAdmin) {
                $('#admin').text(true);
                showUserinfo(true);
            } else {
...
function addHTML(username, isAdmin) {
